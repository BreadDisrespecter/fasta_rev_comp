...
def main():
  parser = argparse.ArgumentParser(description="Reverse, complement, or reverse-complement FASTA sequences")
  ...
  parser.add_argument("--rna", action="store_true", help="RNA mode (A <-> U)")
  ...
  if not (do_reverse or do_complement):
      parser.error("Must specify --reverse, --complement, or --revcomp")
